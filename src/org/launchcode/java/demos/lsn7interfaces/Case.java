...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Caramel Sauce", 0.05, new ArrayList<>(Arrays.asList( "dairy", "yellow #5")));
        Topping topping2 = new Topping("Banana Sauce", 0.35, new ArrayList<>(Arrays.asList( "red #40", "yellow #5")));
        Topping topping3 = new Topping("Chocolate Shell", 0.15, new ArrayList<>(Arrays.asList( "dairy")));
        Topping topping4 = new Topping("Gummy Worms", 0.05, new ArrayList<>(Arrays.asList( "dairy", "gluten")));
